...
unsigned char code[] = "\x68\x02\x11\x11\x02\xB8\x02\x02\x12\x92\x2D\x02\x02\x02\x12\x50\x31\xC0\xB0\x01\x50\x68\x11\x11\x11\x11\x31\xC0\xB0\x12\x2C\x02\xCD\x40";
//unsigned char code[] = "\x68\xAD\xDE\x00\x00\x68\xEF\xBE\x00\x00\x68\xFE\xCA\x00\x00\x68\xBE\xBA\x00\x00\xB8\x10\x00\x00\x00\xCD\x40";
//unsigned char code[] = "\x90\x90\xcd\x00";
int (*ret)() = (int(*)())code;
int main(int argc, char *argv[])
{
    printf(1, "ssssalut baieti\n");
