...
public class ConstraintAnchor {
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        } else if (type2 == Type.BASELINE && (constraintAnchor.getOwner().hasBaseline() == null || getOwner().hasBaseline() == null)) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (this.mType) {
            ...
            case NONE:
                return false;
            case LEFT:
                constraintAnchor = C00031.f0x1d400623[constraintAnchor.getType().ordinal()];
