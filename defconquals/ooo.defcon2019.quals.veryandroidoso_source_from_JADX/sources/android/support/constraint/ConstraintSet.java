...
public class ConstraintSet {
    ...
    private static class Constraint {
        ...
        private void fillFromConstraints(ConstraintHelper constraintHelper, int i, LayoutParams layoutParams) {
        ...
        private void fillFromConstraints(int i, LayoutParams layoutParams) {
            ...
            if (constraint2.mHelperType != -1) {
                if (constraint2.mHelperType == 1) {
                    ...
                    if (constraint2.mReferenceIds != null) {
                        ...
                        constraint2.mReferenceIds = convertReferenceString(childAt, constraint2.mReferenceIdString);
                        childAt.setReferencedIds(constraint2.mReferenceIds);
                    }
    ...
    public void connect(int i, int i2, int i3, int i4, int i5) {
        ...
        switch (i2) {
            ...
            default:
                ...
                i3.append(sideToString(i2));
                i3.append(" to ");
                i3.append(sideToString(i4));
                i3.append(" unknown");
    ...
    public void setGoneMargin(int i, int i2, int i3) {
        ...
        switch (i2) {
            case 1:
                ...
                return;
            case 2:
                i.goneRightMargin = i3;
                return;
            case 3:
                i.goneTopMargin = i3;
                return;
            case 4:
                i.goneBottomMargin = i3;
                return;
            case 5:
                throw new IllegalArgumentException("baseline does not support margins");
            case 6:
                i.goneStartMargin = i3;
                return;
            case 7:
                i.goneEndMargin = i3;
                return;
    ...
    public void createBarrier(int i, int i2, int... iArr) {
        i = get(i);
        i.mHelperType = 1;
        i.mBarrierDirection = i2;
        i.mIsGuideline = false;
        i.mReferenceIds = iArr;
    }

    public void setGuidelineBegin(int i, int i2) {
        get(i).guideBegin = i2;
        get(i).guideEnd = -1;
        get(i).guidePercent = -1082130432;
    }
                ...
                if (eventType != 0) {
                    switch (eventType) {
                        case 2:
                            ...
                            Constraint fillFromAttributeList = fillFromAttributeList(context, Xml.asAttributeSet(i));
...
*/
    ...
    L_0x0013:
        r5 = r11[r3];
        r5 = r5.trim();
        r6 = android.support.constraint.C0001R.id.class;	 Catch:{ Exception -> 0x0025 }
    ...
    L_0x0046:
        ...
        r5 = r7.getDesignInformation(r2, r5);
    ...
    L_0x006b:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.constraint.ConstraintSet.convertReferenceString(android.view.View, java.lang.String):int[]");
    }
}
