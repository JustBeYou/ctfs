...
flag_encoded = "'\263s\235\365\021\347\261\263\276\231\263\371\371\3640\033q\231s#e\231\261e\021\021\276#\231'\371#\231\005e\316"
flag = ""

while len(flag) != len(flag_encoded):
    for c in flag_encoded:
        for i in range(32, 127):
            if ord(c) == encode_char(chr(i)):
                flag += chr(i)
                print (flag)
                break
