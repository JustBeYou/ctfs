...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object v1, p0, Landroid/support/multidex/b;->d:Ljava/io/RandomAccessFile;

    :try_start_0
    iget-object v1, p0, Landroid/support/multidex/b;->d:Ljava/io/RandomAccessFile;

    invoke-virtual {v1}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object v1

    iput-object v1, p0, Landroid/support/multidex/b;->e:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iget-object v1, p0, Landroid/support/multidex/b;->e:Ljava/nio/channels/FileChannel;

    invoke-virtual {v1}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;

    move-result-object v1

    iput-object v1, p0, Landroid/support/multidex/b;->f:Ljava/nio/channels/FileLock;
    :try_end_1
...
.method private a()Ljava/util/List;
    ...
    new-instance v9, Landroid/support/multidex/b$a;

    iget-object v1, p0, Landroid/support/multidex/b;->c:Ljava/io/File;

    invoke-direct {v9, v1, v0}, Landroid/support/multidex/b$a;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-static {v9}, Landroid/support/multidex/b;->b(Ljava/io/File;)J

    move-result-wide v0

    iput-wide v0, v9, Landroid/support/multidex/b$a;->a:J
    :try_end_1
    ...
    invoke-virtual {v9}, Landroid/support/multidex/b$a;->getAbsolutePath()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Landroid/support/multidex/b$a;->length()J
    ...
    iget-wide v12, v9, Landroid/support/multidex/b$a;->a:J
    ...
    invoke-virtual {v9}, Landroid/support/multidex/b$a;->delete()Z

    invoke-virtual {v9}, Landroid/support/multidex/b$a;->exists()Z
    ...
    invoke-virtual {v9}, Landroid/support/multidex/b$a;->getPath()Ljava/lang/String;
...
.method private a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iput-wide v10, v8, Landroid/support/multidex/b$a;->a:J
    ...
    iget-wide v0, v8, Landroid/support/multidex/b$a;->a:J
...
.method private static a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    check-cast v0, Landroid/support/multidex/b$a;
    ...
    iget-wide v6, v0, Landroid/support/multidex/b$a;->a:J
    ...
    invoke-virtual {v0}, Landroid/support/multidex/b$a;->lastModified()J
...
.method a(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-wide v2, p0, Landroid/support/multidex/b;->b:J

    invoke-static {p1, v0, v2, v3, p2}, Landroid/support/multidex/b;->a(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    iget-wide v4, p0, Landroid/support/multidex/b;->b:J

    move-object v0, p1

    move-object v1, p2

    invoke-static/range {v0 .. v6}, Landroid/support/multidex/b;->a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
