...
# static fields
.field private static d:Landroid/support/v7/app/p;
...
.method static a()Landroid/support/v7/app/p;
    .locals 1

    sget-object v0, Landroid/support/v7/app/p;->d:Landroid/support/v7/app/p;
    ...
    sput-object v0, Landroid/support/v7/app/p;->d:Landroid/support/v7/app/p;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/app/p;->c:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/p;->a:J

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/p;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/app/p;->a:J
    ...
    iget-wide v2, p0, Landroid/support/v7/app/p;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/app/p;->a:J
