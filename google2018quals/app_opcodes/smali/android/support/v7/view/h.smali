...
.field b:Landroid/support/v4/h/s;
...
.field private final f:Landroid/support/v4/h/t;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/h/t;
...
.method public a(Landroid/support/v4/h/r;)Landroid/support/v7/view/h;
    .locals 1
...
.method public a(Landroid/support/v4/h/r;Landroid/support/v4/h/r;)Landroid/support/v7/view/h;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/h/r;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/h/r;->b(J)Landroid/support/v4/h/r;
...
.method public a(Landroid/support/v4/h/s;)Landroid/support/v7/view/h;
    .locals 1
    ...
    iput-object p1, p0, Landroid/support/v7/view/h;->b:Landroid/support/v4/h/s;
...
.method public a()V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/h/r;->a(J)Landroid/support/v4/h/r;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/h/r;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/h/r;

    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/h;->b:Landroid/support/v4/h/s;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/h/t;
