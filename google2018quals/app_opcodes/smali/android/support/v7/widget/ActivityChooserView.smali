...
.field private final j:Landroid/support/v7/widget/ai;
...
.field private n:Landroid/support/v7/widget/aj;
...
.method a(I)V
    ...
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/aj;

    move-result-object v3

    invoke-virtual {v3}, Landroid/support/v7/widget/aj;->d()Z
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/aj;->g(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/aj;->a()V
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/aj;->e()Landroid/widget/ListView;
...
.method getListPopupWindow()Landroid/support/v7/widget/aj;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/aj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/aj;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/aj;->b(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->j:Landroid/support/v7/widget/ai;
