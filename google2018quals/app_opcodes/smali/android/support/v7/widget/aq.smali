...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    iput v3, p0, Landroid/support/v7/widget/aq;->q:I

    iput v2, p0, Landroid/support/v7/widget/aq;->s:I

    iput v2, p0, Landroid/support/v7/widget/aq;->t:I

    iput v2, p0, Landroid/support/v7/widget/aq;->u:I

    iput v2, p0, Landroid/support/v7/widget/aq;->v:I

    iput v2, p0, Landroid/support/v7/widget/aq;->w:I

    iput v2, p0, Landroid/support/v7/widget/aq;->x:I
    ...
    iput v0, p0, Landroid/support/v7/widget/aq;->o:I
...
.method private a(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    iget-object v3, p0, Landroid/support/v7/widget/aq;->n:Ljava/util/WeakHashMap;
...
.method private a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3}, Landroid/support/v7/widget/aq;->b(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3, v0}, Landroid/support/v7/widget/aq;->a(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    :try_end_0
...
.method public static a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Landroid/support/v7/widget/aq;->a(Landroid/database/Cursor;I)Ljava/lang/String;
...
.method private b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/aq;->d:Landroid/content/Context;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/aq;->r:Landroid/content/res/ColorStateList;
...
.method private g(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/aq;->a(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
...
.method public a(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    :goto_0
    iget-object v2, p0, Landroid/support/v7/widget/aq;->k:Landroid/support/v7/widget/SearchView;
    ...
    :cond_2
    :try_start_0
    iget-object v2, p0, Landroid/support/v7/widget/aq;->l:Landroid/app/SearchableInfo;

    const/16 v3, 0x32

    invoke-virtual {p0, v2, v0, v3}, Landroid/support/v7/widget/aq;->a(Landroid/app/SearchableInfo;Ljava/lang/String;I)Landroid/database/Cursor;
...
.method public a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/aq$a;-><init>(Landroid/view/View;)V
...
.method public a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget v1, p0, Landroid/support/v7/widget/aq;->x:I
    ...
    :goto_0
    iget-object v3, v0, Landroid/support/v7/widget/aq$a;->a:Landroid/widget/TextView;

    if-eqz v3, :cond_0

    iget v3, p0, Landroid/support/v7/widget/aq;->s:I

    invoke-static {p3, v3}, Landroid/support/v7/widget/aq;->a(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v3

    iget-object v4, v0, Landroid/support/v7/widget/aq$a;->a:Landroid/widget/TextView;

    invoke-direct {p0, v4, v3}, Landroid/support/v7/widget/aq;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    :cond_0
    iget-object v3, v0, Landroid/support/v7/widget/aq$a;->b:Landroid/widget/TextView;

    if-eqz v3, :cond_2

    iget v3, p0, Landroid/support/v7/widget/aq;->u:I
    ...
    invoke-direct {p0, v3}, Landroid/support/v7/widget/aq;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_2
    iget-object v4, v0, Landroid/support/v7/widget/aq$a;->b:Landroid/widget/TextView;

    invoke-direct {p0, v4, v3}, Landroid/support/v7/widget/aq;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    :cond_2
    iget-object v3, v0, Landroid/support/v7/widget/aq$a;->c:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v3, v4, v5}, Landroid/support/v7/widget/aq;->a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    :cond_3
    iget-object v3, v0, Landroid/support/v7/widget/aq$a;->d:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v3, v4, v8}, Landroid/support/v7/widget/aq;->a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    :cond_4
    iget v3, p0, Landroid/support/v7/widget/aq;->q:I
    ...
    :cond_5
    iget-object v1, v0, Landroid/support/v7/widget/aq$a;->e:Landroid/widget/ImageView;

    invoke-virtual {v1, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v1, v0, Landroid/support/v7/widget/aq$a;->e:Landroid/widget/ImageView;

    iget-object v2, v0, Landroid/support/v7/widget/aq$a;->a:Landroid/widget/TextView;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/aq$a;->e:Landroid/widget/ImageView;
    ...
    :cond_6
    iget v3, p0, Landroid/support/v7/widget/aq;->t:I
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/aq;->c:Landroid/database/Cursor;

    invoke-virtual {p0, v0, v1, p3}, Landroid/support/v7/widget/aq;->b(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/aq$a;->a:Landroid/widget/TextView;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v0, v1, p3}, Landroid/support/v7/widget/aq;->a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/aq;->k:Landroid/support/v7/widget/SearchView;
