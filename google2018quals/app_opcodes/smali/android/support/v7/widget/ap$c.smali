...
.method public constructor <init>(Landroid/support/v7/widget/ap;Landroid/content/Context;Landroid/support/v7/app/a$c;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ap$c;->b:[I

    iput-object p3, p0, Landroid/support/v7/widget/ap$c;->c:Landroid/support/v7/app/a$c;

    iget-object v0, p0, Landroid/support/v7/widget/ap$c;->b:[I

    sget v1, Landroid/support/v7/a/a$a;->actionBarTabStyle:I

    invoke-static {p2, v3, v0, v1, v2}, Landroid/support/v7/widget/aw;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/aw;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aw;->g(I)Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ap$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ap$c;->setGravity(I)V
...
.method public a()V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ap$c;->c:Landroid/support/v7/app/a$c;
    ...
    :cond_0
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/ap$c;->addView(Landroid/view/View;)V

    :cond_1
    iput-object v4, p0, Landroid/support/v7/widget/ap$c;->f:Landroid/view/View;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/ap$c;->f:Landroid/view/View;

    if-eqz v0, :cond_5

    iget-object v0, p0, Landroid/support/v7/widget/ap$c;->f:Landroid/view/View;

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ap$c;->removeView(Landroid/view/View;)V
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ap$c;->e:Landroid/widget/ImageView;
    ...
    new-instance v6, Landroid/support/v7/widget/ai$a;

    invoke-direct {v6, v8, v8}, Landroid/support/v7/widget/ai$a;-><init>(II)V

    iput v9, v6, Landroid/support/v7/widget/ai$a;->h:I

    invoke-virtual {v5, v6}, Landroid/widget/ImageView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {p0, v5, v2}, Landroid/support/v7/widget/ap$c;->addView(Landroid/view/View;I)V

    iput-object v5, p0, Landroid/support/v7/widget/ap$c;->e:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ap$c;->d:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v5}, Landroid/support/v7/widget/ap$c;->addView(Landroid/view/View;)V

    iput-object v5, p0, Landroid/support/v7/widget/ap$c;->d:Landroid/widget/TextView;
...
.method public onMeasure(II)V
    ...
    iget v1, v1, Landroid/support/v7/widget/ap;->c:I
...
.method public setSelected(Z)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ap$c;->sendAccessibilityEvent(I)V
