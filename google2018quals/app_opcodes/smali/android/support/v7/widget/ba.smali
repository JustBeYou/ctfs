...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ba;->f:[I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ba;->b:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ba;->c:Landroid/widget/TextView;

    iget-object v0, p0, Landroid/support/v7/widget/ba;->d:Landroid/view/WindowManager$LayoutParams;
...
.method private a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    sget v2, Landroid/support/v7/a/a$d;->tooltip_precise_anchor_threshold:I
    ...
    sget v2, Landroid/support/v7/a/a$d;->tooltip_precise_anchor_extra_offset:I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ba;->a:Landroid/content/Context;
    ...
    :cond_3
    iget-object v3, p0, Landroid/support/v7/widget/ba;->e:Landroid/graphics/Rect;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/ba;->e:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/ba;->g:[I

    invoke-virtual {v5, v3}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v3, p0, Landroid/support/v7/widget/ba;->f:[I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ba;->e:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ba;->b:Landroid/view/View;
...
.method a(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ba;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/ba;->a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ba;->d:Landroid/view/WindowManager$LayoutParams;
