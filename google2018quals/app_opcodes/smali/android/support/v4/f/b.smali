...
.field private static final d:Landroid/support/v4/g/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/k;
...
.method static synthetic a(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/graphics/Typeface;
    .locals 1

    invoke-static {p0, p1, p2}, Landroid/support/v4/f/b;->b(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a;Landroid/widget/TextView;III)Landroid/graphics/Typeface;
    .locals 6
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/g/g;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, p5}, Landroid/support/v4/f/b;->b(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/graphics/Typeface;
    ...
    :cond_2
    new-instance v3, Landroid/support/v4/f/b$1;

    invoke-direct {v3, p0, p1, p5, v2}, Landroid/support/v4/f/b$1;-><init>(Landroid/content/Context;Landroid/support/v4/f/a;ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v3, p4}, Landroid/support/v4/f/c;->a(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
    ...
    new-instance v4, Landroid/support/v4/f/b$2;

    invoke-direct {v4, v0, p2, p5}, Landroid/support/v4/f/b$2;-><init>(Ljava/lang/ref/WeakReference;Landroid/widget/TextView;I)V
    ...
    :try_start_1
    sget-object v0, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/k;

    invoke-virtual {v0, v2}, Landroid/support/v4/g/k;->containsKey(Ljava/lang/Object;)Z
    ...
    sget-object v4, Landroid/support/v4/f/b;->d:Landroid/support/v4/g/k;

    invoke-virtual {v4, v2, v0}, Landroid/support/v4/g/k;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v4, Landroid/support/v4/f/b$3;

    invoke-direct {v4, v2}, Landroid/support/v4/f/b$3;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v3, v4}, Landroid/support/v4/f/c;->a(Ljava/util/concurrent/Callable;Landroid/support/v4/f/c$a;)V
...
.method private static b(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/graphics/Typeface;
    .locals 3
    ...
    invoke-static {p0, v0, v1, p2}, Landroid/support/v4/c/c;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
...
.method static synthetic c()Landroid/support/v4/g/k;
    .locals 1
