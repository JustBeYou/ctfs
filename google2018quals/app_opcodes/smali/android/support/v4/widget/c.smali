...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/widget/c;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/c$a;-><init>(Landroid/support/v4/widget/c;)V

    iput-object v1, p0, Landroid/support/v4/widget/c;->f:Landroid/support/v4/widget/c$a;

    new-instance v1, Landroid/support/v4/widget/c$b;

    invoke-direct {v1, p0}, Landroid/support/v4/widget/c$b;-><init>(Landroid/support/v4/widget/c;)V

    iput-object v1, p0, Landroid/support/v4/widget/c;->g:Landroid/database/DataSetObserver;

    :goto_3
    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v4/widget/c;->f:Landroid/support/v4/widget/c$a;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/c;->g:Landroid/database/DataSetObserver;
    ...
    :cond_5
    iput-object v3, p0, Landroid/support/v4/widget/c;->f:Landroid/support/v4/widget/c$a;

    iput-object v3, p0, Landroid/support/v4/widget/c;->g:Landroid/database/DataSetObserver;
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p2, v0, v1}, Landroid/support/v4/widget/c;->a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
