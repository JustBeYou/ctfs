...
.method constructor <init>(Landroid/support/b/a/i$f;)V
    ...
    iget-object v2, p1, Landroid/support/b/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v0, v1, v2}, Landroid/support/b/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p2, v2, v3, v4}, Landroid/support/v4/b/a/c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {p1, p2, v2, v3, v4}, Landroid/support/v4/b/a/c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    invoke-static {p1, p2, v0, v2, v3}, Landroid/support/v4/b/a/c;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    iget v2, v1, Landroid/support/b/a/i$e;->b:F
    ...
    iget v2, v1, Landroid/support/b/a/i$e;->c:F
    ...
    invoke-virtual {v1, v0}, Landroid/support/b/a/i$e;->setAlpha(F)V
    ...
    iput-object v0, v1, Landroid/support/b/a/i$e;->g:Ljava/lang/String;

    iget-object v2, v1, Landroid/support/b/a/i$e;->h:Landroid/support/v4/g/a;
...
.method private a()Z
    ...
    invoke-static {p0}, Landroid/support/v4/c/a/a;->g(Landroid/graphics/drawable/Drawable;)I
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v3, p0, Landroid/support/b/a/i;->c:Landroid/support/b/a/i$f;
    ...
    iget-object v0, v4, Landroid/support/b/a/i$e;->a:Landroid/support/b/a/i$c;
    ...
    new-instance v1, Landroid/support/b/a/i$b;

    invoke-direct {v1}, Landroid/support/b/a/i$b;-><init>()V

    invoke-virtual {v1, p1, p3, p4, p2}, Landroid/support/b/a/i$b;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v0, v0, Landroid/support/b/a/i$c;->a:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1}, Landroid/support/b/a/i$b;->getPathName()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object v0, v4, Landroid/support/b/a/i$e;->h:Landroid/support/v4/g/a;

    invoke-virtual {v1}, Landroid/support/b/a/i$b;->getPathName()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v0, v7, v1}, Landroid/support/v4/g/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    const/4 v0, 0x0

    iget v7, v3, Landroid/support/b/a/i$f;->a:I

    iget v1, v1, Landroid/support/b/a/i$b;->o:I

    or-int/2addr v1, v7

    iput v1, v3, Landroid/support/b/a/i$f;->a:I
    ...
    new-instance v7, Landroid/support/b/a/i$a;

    invoke-direct {v7}, Landroid/support/b/a/i$a;-><init>()V

    invoke-virtual {v7, p1, p3, p4, p2}, Landroid/support/b/a/i$a;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v0, v0, Landroid/support/b/a/i$c;->a:Ljava/util/ArrayList;

    invoke-virtual {v0, v7}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v7}, Landroid/support/b/a/i$a;->getPathName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v8, v7}, Landroid/support/v4/g/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_4
    iget v0, v3, Landroid/support/b/a/i$f;->a:I

    iget v7, v7, Landroid/support/b/a/i$a;->o:I

    or-int/2addr v0, v7

    iput v0, v3, Landroid/support/b/a/i$f;->a:I
    ...
    new-instance v7, Landroid/support/b/a/i$c;

    invoke-direct {v7}, Landroid/support/b/a/i$c;-><init>()V

    invoke-virtual {v7, p1, p3, p4, p2}, Landroid/support/b/a/i$c;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {v7}, Landroid/support/b/a/i$c;->getGroupName()Ljava/lang/String;
    ...
    iget v7, v7, Landroid/support/b/a/i$c;->c:I
...
.method a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/b/a/i$e;->h:Landroid/support/v4/g/a;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v2, v3, v1}, Landroid/support/b/a/i$f;->b(II)V
    ...
    invoke-virtual {v2, v3, v1}, Landroid/support/b/a/i$f;->a(II)V
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v2, v0, Landroid/support/b/a/i$f;->c:Landroid/content/res/ColorStateList;

    iget-object v0, v0, Landroid/support/b/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v1, v2, v0}, Landroid/support/b/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
