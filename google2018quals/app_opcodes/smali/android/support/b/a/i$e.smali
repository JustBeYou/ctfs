...
.method private a(Landroid/support/b/a/i$c;Landroid/support/b/a/i$d;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    iget v1, p0, Landroid/support/b/a/i$e;->d:F

    div-float/2addr v0, v1

    int-to-float v1, p5

    iget v2, p0, Landroid/support/b/a/i$e;->e:F
    ...
    invoke-direct {p0, v3}, Landroid/support/b/a/i$e;->a(Landroid/graphics/Matrix;)F
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/b/a/i$e;->i:Landroid/graphics/Path;

    invoke-virtual {p2, v0}, Landroid/support/b/a/i$d;->a(Landroid/graphics/Path;)V
    ...
    iget-object v2, p0, Landroid/support/b/a/i$e;->l:Landroid/graphics/Matrix;

    invoke-virtual {v1, v0, v2}, Landroid/graphics/Path;->addPath(Landroid/graphics/Path;Landroid/graphics/Matrix;)V

    iget-object v0, p0, Landroid/support/b/a/i$e;->j:Landroid/graphics/Path;
    ...
    iget v3, p2, Landroid/support/b/a/i$b;->g:F
    ...
    iget v3, p2, Landroid/support/b/a/i$b;->h:F
    ...
    iput-object v5, p0, Landroid/support/b/a/i$e;->o:Landroid/graphics/PathMeasure;

    :cond_4
    iget-object v5, p0, Landroid/support/b/a/i$e;->o:Landroid/graphics/PathMeasure;

    iget-object v6, p0, Landroid/support/b/a/i$e;->i:Landroid/graphics/Path;
    ...
    iget-object v3, p0, Landroid/support/b/a/i$e;->o:Landroid/graphics/PathMeasure;
    ...
    iget v0, p2, Landroid/support/b/a/i$b;->c:I
    ...
    iput-object v0, p0, Landroid/support/b/a/i$e;->n:Landroid/graphics/Paint;
    ...
    iget v4, p2, Landroid/support/b/a/i$b;->f:F

    invoke-static {v0, v4}, Landroid/support/b/a/i;->a(IF)I
    ...
    iget v0, p2, Landroid/support/b/a/i$b;->e:I
    ...
    :cond_7
    iget v0, p2, Landroid/support/b/a/i$b;->a:I
    ...
    iput-object v0, p0, Landroid/support/b/a/i$e;->m:Landroid/graphics/Paint;
    ...
    iget-object v3, p2, Landroid/support/b/a/i$b;->k:Landroid/graphics/Paint$Join;
    ...
    :cond_9
    iget-object v3, p2, Landroid/support/b/a/i$b;->j:Landroid/graphics/Paint$Cap;
    ...
    :cond_a
    iget v3, p2, Landroid/support/b/a/i$b;->l:F

    invoke-virtual {v0, v3}, Landroid/graphics/Paint;->setStrokeMiter(F)V

    iget v3, p2, Landroid/support/b/a/i$b;->a:I

    iget v4, p2, Landroid/support/b/a/i$b;->d:F

    invoke-static {v3, v4}, Landroid/support/b/a/i;->a(IF)I
    ...
    iget v2, p2, Landroid/support/b/a/i$b;->b:F
